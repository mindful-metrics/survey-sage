...
import { submitFormData } from './externalApiClient'

describe('Integration tests for health app endpoints: Success cases', () => {
  ...
  test('returns success for valid taskId and answers', async () => {
...
describe('Integration tests for health app endpoitns: Failure cases', () => {
  let originalFetch: typeof fetch
